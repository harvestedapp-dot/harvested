...
export function ProblemsSection() {
  return (
    <section
      ...
      className="bg-[#f5f4f0] px-10 py-20 sm:py-28"
    >
      <div className="mx-auto max-w-[1280px]">
          ...
          <div className="rounded-2xl border-[0.5px] border-[#dddbd2] bg-white p-8">
            ...
            <ul>
              {pains.map((pain) => (
                <li
                  key={pain}
                  className="flex items-start gap-4 border-b-[0.5px] border-[#eeecea] py-4 last:border-b-0"
                >
                  <span
                    aria-hidden
          ...
          <div className="rounded-2xl bg-[#1a3320] p-8">
            ...
            <ul>
              {solutions.map((solution) => (
                <li
                  key={solution}
                  className="flex items-start gap-4 border-b-[0.5px] border-white/[0.08] py-4 last:border-b-0"
                >
                  <span
                    aria-hidden
        ...
        <div className="mt-10 text-center">
          <Link
            ...
            className="inline-block w-full rounded-lg bg-[#1a3320] px-10 py-4 text-[17px] font-medium text-white transition-opacity hover:opacity-90 sm:w-auto"
          >
            Enroll Now &mdash; $69
          </Link>
        </div>
