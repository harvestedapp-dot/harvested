...
export async function generateMetadata({
  ...
  const title =
    locale === "hy"
      ? `${siteConfig.name} | Ներսի պարտիզպանութեան դասընթաց սկսնակներու համար`
      : `${siteConfig.name} | Indoor Gardening Course for Beginners`;

  const keywords =
    locale === "hy"
      ? [
          "ներսի պարտիզպանութիւն",
          "ներսը բոյս աճեցնել",
          "պարտիզպանութեան դասընթաց",
          "բոյսերու խնամք",
          "սերմէն մինչեւ բերք",
          "աճի լոյս",
          "հայերէն առցանց դասընթաց",
        ]
      : [
  ...
  return {
    ...
    knowsAbout:
      locale === "hy"
        ? [
            "Ներսի պարտիզպանութիւն",
            "Ներսը բոյս աճեցնել սկսնակներու համար",
            "Սերմի ցանք եւ ծլում",
            "Աճի լոյսեր եւ ներսի լուսաւորութիւն",
            "Ջրում եւ բոյսի սնուցում",
            "pH-ի եւ EC-ի չափում",
            "Ջերմաստիճան, խոնաւութիւն եւ օդափոխութիւն",
